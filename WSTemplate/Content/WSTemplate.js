  ...
  WSTemplate:{
   Client:{
    Main:Runtime.Field(function()
    {
     ...
     insert(Doc.Concat([Doc.Element("div",[],[Doc.TextNode("Hello world")])]));
     arg20=List.ofArray([Doc.TextNode("Hello 1")]);
     arg201=List.ofArray([Doc.TextNode("Hello 2")]);
     Links=List.ofArray([Doc.Element("li",[],arg20),Doc.Element("li",[],arg201)]);
     insert(Doc.Concat([Doc.Element("ul",[],Arrays.ofSeq(Links))]));
     arg202=List.ofArray([Doc.TextNode("Something...")]);
     Content=List.ofArray([Doc.Element("p",[],arg202)]);
     insert(Doc.Concat([Doc.Element("h1",[],[Doc.TextNode("Some title")]),Doc.TextNode("\n"),Doc.Concat(Content)]));
     FirstBody=List.ofArray([Doc.Concat([Doc.TextNode("\n        "),Doc.Element("h4",[AttrProxy.Create("class","list-group-item-heading")],[Doc.TextNode("First")]),Doc.TextNode("\n        "),Doc.Element("p",[AttrProxy.Create("class","list-group-item-text")],[]),Doc.TextNode("\n    ")])]);
